...
- [x] 30-02-PLAN.md — paired-t significance via stdlib + hardcoded t-table (GATE-03) + --rebuild-baseline + multi-skill detection + baseline cache staleness (completes GATE-01) — **shipped 2026-06-24 (4 commits, 30 new tests green, 100/101 eval tests pass, FOUND-08 + runtime isolation + scipy-free verified; Phase 30 COMPLETE)**
