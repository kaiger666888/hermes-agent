...
Plans:
- [ ] 15-01-PLAN.md — Create audio_pipeline/ with merged SKILL.md (sub_steps + aliases + unioned related_skills + Spatial Audio Disposition section + lip_sync NODE-09 note) + 6 sub-folder refs + consolidated GAP-REPORT + 6 redirect stubs (5 merged_into + 1 folded_into for spatial_audio) (Wave 1)
