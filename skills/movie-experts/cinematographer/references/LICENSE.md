# LICENSE — cinematographer references

**Owner:** Phase 4 plan `04` (single owner — EXPERT-CINE / cinematographer expert).
**Last updated:** 2026-06-15
verified_date: 2026-06

## Scope

This directory (`skills/movie-experts/cinematographer/references/`) contains 5 curated reference files that form the cinematographer expert's RAG corpus. Each ref paraphrases concrete heuristics (numbers, rules, thresholds) drawn from the source listed below. **No ref reproduces copyrighted scene description, dialogue, storyboards, or continuous prose beyond the Fair Use quota (quoted heuristics only; ≤ 5 specific prompt-token examples per video gen model; no film-still reproduction; no reproduction of specific E-Konte pages or protected cut drawings).**
...
| `e-konte-format.md` (Phase 20 v4.0) | Japanese animation industry standard terminology (絵コンテ / Layout / ト書き / 絵切り — public, non-single-copyright-holder, formalized at Mushi Production 1960s) + Studio Ghibli production documentaries (*The Kingdom of Dreams and Madness* 2013 NHK / DW; *10 Years with Hayao Miyazaki* 2019 NHK) + Satoshi Kon case from public secondary literature (Catherine Munroe Hotes *A Critical Study of the Genesis and Evolution of Kon Satoshi* 2010; Suzuki *Kon Satoshi: The Illusionist* 2021) + Tony Zhou "Every Frame a Painting" public video essays + Marcin Nowak "Anime Storyboard Tradition vs Western Live-Action Storyboard" public comparative essay (2018) | Fair Use — paraphrased 5-layer E-Konte annotation taxonomy (industry-common terminology) + comparative table to Western storyboard + Satoshi Kon / Hayao Miyazaki cases referenced at citation level (≤1-2 paragraphs each); no reproduction of specific E-Konte pages, protected cut drawings, or frame-level storyboards from any production |
