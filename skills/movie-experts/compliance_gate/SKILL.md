...
- 多平台分发时同一 mastercut 的差异化剪辑(抖音版 / 快手版 / 小程序剧版)
...
```
tags="expert:compliance_gate,domain:cn-content-rules"
tags="expert:compliance_gate,domain:viral-element-catalog"
tags="expert:compliance_gate,domain:platform-specs-<platform>"
```
