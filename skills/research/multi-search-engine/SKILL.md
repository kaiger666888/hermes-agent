...
metadata:
  hermes:
    tags: [Search, Multi-Engine, Web-Search, No-API-Key, CN, Global]
    category: research
    related_skills: [deep-research, arxiv]
---
...
3. **Controlled Search**: Use `web_extract` to execute search requests with rate limiting:
...
```javascript
// Basic search
web_extract(urls=["https://www.google.com/search?q=python+tutorial"])

// Site-specific
web_extract(urls=["https://www.google.com/search?q=site:github.com+react"])

// File type
web_extract(urls=["https://www.google.com/search?q=machine+learning+filetype:pdf"])

// Time filter (past week)
web_extract(urls=["https://www.google.com/search?q=ai+news&tbs=qdr:w"])

// Privacy search
web_extract(urls=["https://duckduckgo.com/html/?q=privacy+tools"])

// DuckDuckGo Bangs
web_extract(urls=["https://duckduckgo.com/html/?q=!gh+tensorflow"])
...
- `references/advanced-search.md` - Domestic (CN) search engine deep guide
- `references/international-search.md` - International search engine deep guide
